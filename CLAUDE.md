...
- **Elke tekstlink heeft zijn eigen `font-family`.** Word erft geen lettertype in een `<a>`: zonder die regel staat de linktekst in Times New Roman terwijl de rest van de mail klopt. Dat trof het menu, "Online lezen", de agenda-links en de hele footer. Zet bij een nieuwe link altijd het bodyfont van het merk in de `style`.
- **Het menu rechtsboven is een tabel met één cel per link**, rechts gezet met `align="right"`. Losse inline links met `padding` ernaast zijn in Word onbetrouwbaar — de ruimte ertussen valt weg en de uitlijning klopt niet. Er is bewust **geen aparte Outlook-kopie** van het menu: die zou verouderen zodra je een label of bestemming aanpast. Opgeslagen nieuwsbrieven worden bij het openen omgebouwd, met behoud van teksten en links.
- **Celbreedtes in de header tellen op tot 600** (240 voor het logo, 360 voor het menu). Word neemt een opgegeven breedte letterlijk; een cel die smaller is opgegeven dan zijn inhoud duwt de rest scheef. Reken bij een wijziging met Arial, want dat is het font dat Outlook er zet.
